...
class Solution {
    ...
    hasPathSum(root, targetSum, runningSum = 0) {
        console.log({root,left:root?.left || null,right:root?.right|| null})
        ...
        return this.hasPathSum(root.left, targetSum, runningSum) || this.hasPathSum(root.right, targetSum, runningSum);
    }
}
